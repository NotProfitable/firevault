...
export default function ImageTile(props: { file: FileDocumentMongo }) {
  ...
  return (
    <figure className="m-2 w-full md:w-full md:flex transition duration-500 ease-in-out bg-gray-100 rounded-xl md:hover:shadow-lg m-4">
      ...
      {/*  />*/}
      {/*</div>*/}
      <div className="flex flex-col w-full p-1 md:w-full text-center m-0 md:p-6  text-center  space-y-4">
        <blockquote>
